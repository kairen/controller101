...
import (
	...
	"github.com/cloud-native-taiwan/controller101/pkg/generated/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type CloudnativeV1alpha1Interface interface {
...
func NewForConfig(c *rest.Config) (*CloudnativeV1alpha1Client, error) {
	...
	return &CloudnativeV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new CloudnativeV1alpha1Client for the given config and
...
func New(c rest.Interface) *CloudnativeV1alpha1Client {
	return &CloudnativeV1alpha1Client{c}
}
