...
import (
	...
	cloudnativev1alpha1 "github.com/cloud-native-taiwan/controller101/pkg/apis/cloudnative/v1alpha1"
	versioned "github.com/cloud-native-taiwan/controller101/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/cloud-native-taiwan/controller101/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/cloud-native-taiwan/controller101/pkg/generated/listers/cloudnative/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CloudnativeV1alpha1().VirtualMachines(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CloudnativeV1alpha1().VirtualMachines(namespace).Watch(options)
			},
		},
		&cloudnativev1alpha1.VirtualMachine{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *virtualMachineInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cloudnativev1alpha1.VirtualMachine{}, f.defaultInformer)
}
